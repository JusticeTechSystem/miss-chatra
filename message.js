...
setTimeout(() => {
  ...
  // Background update checker — silently polls GitHub every 6 hours
  try {
    const bu = require("./plugins/botupdate");
    if (bu.startBackgroundChecker) bu.startBackgroundChecker(global.__botSock);
  } catch {}
}, 5000);
...
// Menu number-reply handler (smart dashboards)
    ...
    const reply = async (text) => {
      ...
      // Emoji prefix handled globally in index.js sock.sendMessage override
